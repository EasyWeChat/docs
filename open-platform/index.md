...
第三方应用或者网站网页授权的逻辑和公众号的网页授权基本一样，唯一不同的获取 OAuth 模块的方法需要调整为：
...
$officialAccount = $app->getOfficialAccount($authorization->getAccessToken());
...
$miniApp = $app->getMiniApp($authorization->getAccessToken());
